...
export const zhHans: TranslationStructure = {
    ...
    settingsAccount: {
        ...
        // Push notifications
        pushTitle: 'Push 通知',
        pushFooter: '当会话需要您的操作时——一个问题、权限请求或已完成的任务——在此设备上接收通知。下面的列表显示了哪些设备已设置接收通知。',
        pushPermission: '权限',
        pushPermLabelUnavailable: '不可用',
        pushPermLabelAllowed: '已允许',
        pushPermLabelDenied: '已拒绝',
        pushPermLabelNotRequested: '未请求',
        pushPermChecking: '正在检查此设备的通知权限。',
        pushPermUnsupported: '在您的 iPhone 上打开 Happy（已添加到主屏幕）以开启通知。',
        pushPermGranted: '此设备可以接收通知。',
        pushPermCanAsk: '仍可从应用再次显示系统提示。',
        pushPermBlocked: 'iOS 已停止显示提示。请打开系统设置以重新启用通知。',
        pushEnableTurnOn: '开启通知',
        pushEnableOpenSettings: '打开通知设置',
        pushEnableUnavailableTitle: '通知不可用',
        pushEnableSubUnsupported: '通知仅在 iPhone 和 Android 上可用。',
        pushEnableSubCanAsk: '如果 iOS 仍允许，则再次显示系统提示。',
        pushEnableSubBlocked: '当 iOS 不再显示提示时，打开系统设置。',
        pushRefreshTitle: '刷新此设备',
        pushRefreshSubDefault: '未收到通知？点击重新连接此设备。',
        pushRefreshSubCurrent: ({ token }: { token: string }) => `已连接 · ${token}`,
        pushEnabledSuccess: '此设备的通知已启用。',
        pushNotGranted: '未授予通知权限。',
        pushOpenSettingsTitle: '打开设置',
        pushOpenSettingsBody: 'iOS 不会再显示提示，因此 Happy 打开了设置。',
        pushRefreshedSuccess: '此设备已重新连接。',
        pushNotEnabledYet: '此设备尚未启用通知。',
        pushRequestFailed: '请求通知权限失败。',
        pushRefreshFailed: '重新连接此设备失败。',
        pushLoadFailed: '加载通知设置失败。',
        pushDevicesTitle: ({ count }: { count: number }) => `已注册设备 (${count})`,
        pushDevicesFooter: '已设置接收通知的设备。点击其他设备可将其移除。',
        pushDevicesEmpty: '未注册任何设备',
        pushDevicesEmptySub: '注册此设备后，它将显示在此处。',
        pushDeviceReceiving: '正在接收通知',
        pushDeviceOther: '其他设备 — 点击移除',
        pushDeviceRegistered: ({ date }: { date: string }) => `注册于 ${date}`,
        pushDeviceLastSeen: ({ date }: { date: string }) => `最后出现于 ${date}`,
        pushDeleteTitle: '移除设备',
        pushDeleteBody: ({ name }: { name: string }) => `从您的账户中移除 ${name}？它将停止接收通知。`,
        pushDeleteFailed: '移除设备失败。',
    },
    ...
    terminal: {
        ...
        autoCreateFailed: '无法连接到您的 Mac 来创建账户。请确保它已开机并连接到同一 Wi-Fi，然后重新扫描二维码。',
    },
