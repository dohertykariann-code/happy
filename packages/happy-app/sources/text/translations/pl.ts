...
export const pl: TranslationStructure = {
    ...
    settingsAccount: {
        ...
        pushFooter: 'Otrzymuj powiadomienia na tym urządzeniu, gdy sesja potrzebuje Twojego wkładu — pytanie, prośba o uprawnienia lub ukończone zadanie. Lista poniżej pokazuje urządzenia skonfigurowane do ich odbierania.',
        pushPermission: 'Uprawnienia',
        pushPermLabelUnavailable: 'Niedostępne',
        pushPermLabelAllowed: 'Dozwolone',
        pushPermLabelDenied: 'Odrzucone',
        pushPermLabelNotRequested: 'Nie zaproszono',
        pushPermChecking: 'Sprawdzanie uprawnień do powiadomień dla tego urządzenia.',
        pushPermUnsupported: 'Otwórz Happy na swoim iPhonie (dodanym do ekranu głównego), aby włączyć powiadomienia.',
        pushPermGranted: 'To urządzenie może odbierać powiadomienia.',
        pushPermCanAsk: 'Monit systemowy można ponownie wyświetlić z aplikacji.',
        pushPermBlocked: 'iOS przestał wyświetlać monity. Otwórz Ustawienia systemowe, aby ponownie włączyć powiadomienia.',
        pushEnableTurnOn: 'Włącz powiadomienia',
        pushEnableOpenSettings: 'Otwórz ustawienia powiadomień',
        pushEnableUnavailableTitle: 'Powiadomienia niedostępne',
        pushEnableSubUnsupported: 'Powiadomienia są dostępne tylko na iPhone i Android.',
        pushEnableSubCanAsk: 'Ponownie wyświetla monit systemowy, jeśli iOS jeszcze na to pozwala.',
        pushEnableSubBlocked: 'Otwiera Ustawienia systemowe, gdy iOS nie wyświetli już monitu.',
        pushRefreshTitle: 'Odśwież to urządzenie',
        pushRefreshSubDefault: 'Nie otrzymujesz powiadomień? Dotknij, aby ponownie połączyć urządzenie.',
        pushRefreshSubCurrent: ({ token }: { token: string }) => `Połączono · ${token}`,
        pushEnabledSuccess: 'Powiadomienia są włączone dla tego urządzenia.',
        pushNotGranted: 'Uprawnienie do powiadomień nie zostało przyznane.',
        pushOpenSettingsTitle: 'Otwórz Ustawienia',
        pushOpenSettingsBody: 'iOS nie wyświetli już monitu, więc Happy otworzył Ustawienia.',
        pushRefreshedSuccess: 'Urządzenie zostało ponownie połączone.',
        pushNotEnabledYet: 'Powiadomienia nie są jeszcze włączone dla tego urządzenia.',
        pushRequestFailed: 'Nie udało się poprosić o uprawnienie do powiadomień.',
        pushRefreshFailed: 'Nie udało się ponownie połączyć urządzenia.',
        pushLoadFailed: 'Nie udało się załadować ustawień powiadomień.',
        pushDevicesTitle: ({ count }: { count: number }) => `Zarejestrowane urządzenia (${count})`,
        pushDevicesFooter: 'Urządzenia skonfigurowane do odbierania powiadomień. Dotknij inne urządzenie, aby je usunąć.',
        pushDevicesEmpty: 'Brak zarejestrowanych urządzeń',
        pushDevicesEmptySub: 'Po zarejestrowaniu urządzenie pojawi się tutaj.',
        pushDeviceReceiving: 'Odbiera powiadomienia',
        pushDeviceOther: 'Inne urządzenie — dotknij, aby usunąć',
        pushDeviceRegistered: ({ date }: { date: string }) => `Zarejestrowano ${date}`,
        pushDeviceLastSeen: ({ date }: { date: string }) => `Ostatnio widziano ${date}`,
        pushDeleteTitle: 'Usuń urządzenie',
        pushDeleteBody: ({ name }: { name: string }) => `Usunąć ${name} z Twojego konta? Przestanie odbierać powiadomienia.`,
        pushDeleteFailed: 'Nie udało się usunąć urządzenia.',
    },
    ...
    terminal: {
        ...
        settingUpAccount: 'Konfigurowanie konta…',
        autoCreateFailed: 'Nie udało się połączyć z Twoim Makiem, aby utworzyć konto. Upewnij się, że jest włączony i w tej samej sieci Wi-Fi, a następnie zeskanuj kod QR ponownie.',
    },
