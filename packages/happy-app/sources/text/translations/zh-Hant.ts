...
export const zhHant: TranslationStructure = {
    ...
    settingsAccount: {
        ...
        // Push notifications
        pushTitle: 'Push 通知',
        pushFooter: '當會話需要您的操作時——一個問題、權限請求或已完成的任務——在此裝置上接收通知。下面的清單顯示了哪些裝置已設定接收通知。',
        pushPermission: '權限',
        pushPermLabelUnavailable: '不可用',
        pushPermLabelAllowed: '已允許',
        pushPermLabelDenied: '已拒絕',
        pushPermLabelNotRequested: '未請求',
        pushPermChecking: '正在檢查此裝置的通知權限。',
        pushPermUnsupported: '在您的 iPhone 上開啟 Happy（已新增至主畫面）以啟用通知。',
        pushPermGranted: '此裝置可以接收通知。',
        pushPermCanAsk: '仍可從應用程式再次顯示系統提示。',
        pushPermBlocked: 'iOS 已停止顯示提示。請開啟系統設定以重新啟用通知。',
        pushEnableTurnOn: '開啟通知',
        pushEnableOpenSettings: '開啟通知設定',
        pushEnableUnavailableTitle: '通知不可用',
        pushEnableSubUnsupported: '通知僅在 iPhone 和 Android 上可用。',
        pushEnableSubCanAsk: '如果 iOS 仍允許，則再次顯示系統提示。',
        pushEnableSubBlocked: '當 iOS 不再顯示提示時，開啟系統設定。',
        pushRefreshTitle: '重新整理此裝置',
        pushRefreshSubDefault: '未收到通知？點擊重新連線此裝置。',
        pushRefreshSubCurrent: ({ token }: { token: string }) => `已連線 · ${token}`,
        pushEnabledSuccess: '此裝置的通知已啟用。',
        pushNotGranted: '未授予通知權限。',
        pushOpenSettingsTitle: '開啟設定',
        pushOpenSettingsBody: 'iOS 不會再顯示提示，因此 Happy 開啟了設定。',
        pushRefreshedSuccess: '此裝置已重新連線。',
        pushNotEnabledYet: '此裝置尚未啟用通知。',
        pushRequestFailed: '請求通知權限失敗。',
        pushRefreshFailed: '重新連線此裝置失敗。',
        pushLoadFailed: '載入通知設定失敗。',
        pushDevicesTitle: ({ count }: { count: number }) => `已註冊裝置 (${count})`,
        pushDevicesFooter: '已設定接收通知的裝置。點擊其他裝置可將其移除。',
        pushDevicesEmpty: '未註冊任何裝置',
        pushDevicesEmptySub: '註冊此裝置後，它將顯示在此處。',
        pushDeviceReceiving: '正在接收通知',
        pushDeviceOther: '其他裝置 — 點擊移除',
        pushDeviceRegistered: ({ date }: { date: string }) => `註冊於 ${date}`,
        pushDeviceLastSeen: ({ date }: { date: string }) => `最後出現於 ${date}`,
        pushDeleteTitle: '移除裝置',
        pushDeleteBody: ({ name }: { name: string }) => `從您的帳戶中移除 ${name}？它將停止接收通知。`,
        pushDeleteFailed: '移除裝置失敗。',
    },
    ...
    terminal: {
        ...
        settingUpAccount: '正在設定您的帳戶…',
        autoCreateFailed: '無法連線到您的 Mac 來建立帳戶。請確認它已開機並連線到同一 Wi-Fi，然後重新掃描 QR 碼。',
    },
