...
export const pt: TranslationStructure = {
    ...
    settingsAccount: {
        ...
        pushFooter: 'Receba notificações neste dispositivo quando uma sessão precisar da sua atenção — uma pergunta, uma solicitação de permissão ou uma tarefa concluída. A lista abaixo mostra quais dispositivos estão configurados para recebê-las.',
        pushPermission: 'Permissão',
        pushPermLabelUnavailable: 'Indisponível',
        pushPermLabelAllowed: 'Permitido',
        pushPermLabelDenied: 'Negado',
        pushPermLabelNotRequested: 'Não solicitado',
        pushPermChecking: 'Verificando permissões de notificação para este dispositivo.',
        pushPermUnsupported: 'Abra o Happy no seu iPhone (adicionado à sua Tela de Início) para ativar as notificações.',
        pushPermGranted: 'Este dispositivo pode receber notificações.',
        pushPermCanAsk: 'O prompt do sistema ainda pode ser exibido novamente pelo aplicativo.',
        pushPermBlocked: 'O iOS parou de exibir prompts. Abra as Configurações do sistema para reativar as notificações.',
        pushEnableTurnOn: 'Ativar notificações',
        pushEnableOpenSettings: 'Abrir configurações de notificação',
        pushEnableUnavailableTitle: 'Notificações indisponíveis',
        pushEnableSubUnsupported: 'As notificações estão disponíveis apenas no iPhone e Android.',
        pushEnableSubCanAsk: 'Exibe novamente o prompt do sistema se o iOS ainda permitir.',
        pushEnableSubBlocked: 'Abre as Configurações do sistema quando o iOS não exibir mais o prompt.',
        pushRefreshTitle: 'Atualizar este dispositivo',
        pushRefreshSubDefault: 'Não está recebendo notificações? Toque para reconectar este dispositivo.',
        pushRefreshSubCurrent: ({ token }: { token: string }) => `Conectado · ${token}`,
        pushEnabledSuccess: 'As notificações estão ativadas para este dispositivo.',
        pushNotGranted: 'A permissão de notificação não foi concedida.',
        pushOpenSettingsTitle: 'Abrir Configurações',
        pushOpenSettingsBody: 'O iOS não exibirá mais o prompt, então o Happy abriu as Configurações.',
        pushRefreshedSuccess: 'O dispositivo foi reconectado.',
        pushNotEnabledYet: 'As notificações ainda não estão ativadas para este dispositivo.',
        pushRequestFailed: 'Falha ao solicitar permissão de notificação.',
        pushRefreshFailed: 'Falha ao reconectar este dispositivo.',
        pushLoadFailed: 'Falha ao carregar as configurações de notificação.',
        pushDevicesTitle: ({ count }: { count: number }) => `Dispositivos registrados (${count})`,
        pushDevicesFooter: 'Dispositivos configurados para receber notificações. Toque em outro dispositivo para removê-lo.',
        pushDevicesEmpty: 'Nenhum dispositivo registrado',
        pushDevicesEmptySub: 'Quando este dispositivo for registrado, ele aparecerá aqui.',
        pushDeviceReceiving: 'Recebendo notificações',
        pushDeviceOther: 'Outro dispositivo — toque para remover',
        pushDeviceRegistered: ({ date }: { date: string }) => `Registrado em ${date}`,
        pushDeviceLastSeen: ({ date }: { date: string }) => `Visto pela última vez em ${date}`,
        pushDeleteTitle: 'Remover dispositivo',
        pushDeleteBody: ({ name }: { name: string }) => `Remover ${name} da sua conta? Ele deixará de receber notificações.`,
        pushDeleteFailed: 'Falha ao remover o dispositivo.',
    },
    ...
    terminal: {
        ...
        autoCreateFailed: 'Não foi possível conectar ao seu Mac para criar a conta. Verifique se ele está ligado e na mesma rede Wi-Fi, depois escaneie o código QR novamente.',
    },
