...
export const es: TranslationStructure = {
    ...
    settingsAccount: {
        ...
        pushFooter: 'Recibe notificaciones en este dispositivo cuando una sesión necesita tu intervención — una pregunta, una solicitud de permiso o una tarea finalizada. La lista a continuación muestra qué dispositivos están configurados para recibirlas.',
        pushPermission: 'Permiso',
        pushPermLabelUnavailable: 'No disponible',
        pushPermLabelAllowed: 'Permitido',
        pushPermLabelDenied: 'Denegado',
        pushPermLabelNotRequested: 'No solicitado',
        pushPermChecking: 'Comprobando permisos de notificación para este dispositivo.',
        pushPermUnsupported: 'Abre Happy en tu iPhone (añadido a tu pantalla de inicio) para activar las notificaciones.',
        pushPermGranted: 'Este dispositivo puede recibir notificaciones.',
        pushPermCanAsk: 'El aviso del sistema todavía puede mostrarse de nuevo desde la app.',
        pushPermBlocked: 'iOS ha dejado de mostrar avisos. Abre Configuración del sistema para volver a activar las notificaciones.',
        pushEnableTurnOn: 'Activar notificaciones',
        pushEnableOpenSettings: 'Abrir configuración de notificaciones',
        pushEnableUnavailableTitle: 'Notificaciones no disponibles',
        pushEnableSubUnsupported: 'Las notificaciones solo están disponibles en iPhone y Android.',
        pushEnableSubCanAsk: 'Muestra de nuevo el aviso del sistema si iOS todavía lo permite.',
        pushEnableSubBlocked: 'Abre Configuración del sistema cuando iOS ya no muestre el aviso.',
        pushRefreshTitle: 'Actualizar este dispositivo',
        pushRefreshSubDefault: '¿No recibes notificaciones? Toca para reconectar este dispositivo.',
        pushRefreshSubCurrent: ({ token }: { token: string }) => `Conectado · ${token}`,
        pushEnabledSuccess: 'Las notificaciones están activadas para este dispositivo.',
        pushNotGranted: 'No se concedió permiso para notificaciones.',
        pushOpenSettingsTitle: 'Abrir Configuración',
        pushOpenSettingsBody: 'iOS ya no muestra el aviso, por lo que Happy abrió Configuración.',
        pushRefreshedSuccess: 'El dispositivo fue reconectado.',
        pushNotEnabledYet: 'Las notificaciones aún no están activadas para este dispositivo.',
        pushRequestFailed: 'Error al solicitar permiso de notificación.',
        pushRefreshFailed: 'Error al reconectar este dispositivo.',
        pushLoadFailed: 'Error al cargar la configuración de notificaciones.',
        pushDevicesTitle: ({ count }: { count: number }) => `Dispositivos registrados (${count})`,
        pushDevicesFooter: 'Dispositivos configurados para recibir notificaciones. Toca otro dispositivo para eliminarlo.',
        pushDevicesEmpty: 'No hay dispositivos registrados',
        pushDevicesEmptySub: 'Una vez registrado este dispositivo, aparecerá aquí.',
        pushDeviceReceiving: 'Recibiendo notificaciones',
        pushDeviceOther: 'Otro dispositivo — toca para eliminar',
        pushDeviceRegistered: ({ date }: { date: string }) => `Registrado el ${date}`,
        pushDeviceLastSeen: ({ date }: { date: string }) => `Visto por última vez el ${date}`,
        pushDeleteTitle: 'Eliminar dispositivo',
        pushDeleteBody: ({ name }: { name: string }) => `¿Eliminar ${name} de tu cuenta? Dejará de recibir notificaciones.`,
        pushDeleteFailed: 'Error al eliminar el dispositivo.',
    },
    ...
    terminal: {
        ...
        autoCreateFailed: 'No se pudo conectar con tu Mac para crear la cuenta. Asegúrate de que esté encendido y en la misma red Wi-Fi, luego vuelve a escanear el código QR.',
    },
