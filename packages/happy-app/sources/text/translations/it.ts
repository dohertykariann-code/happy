...
export const it: TranslationStructure = {
    ...
    settingsAccount: {
        ...
        pushFooter: 'Ricevi notifiche su questo dispositivo quando una sessione richiede il tuo intervento — una domanda, una richiesta di autorizzazione o un\'attività completata. L\'elenco qui sotto mostra i dispositivi configurati per riceverle.',
        pushPermission: 'Autorizzazione',
        pushPermLabelUnavailable: 'Non disponibile',
        pushPermLabelAllowed: 'Consentito',
        pushPermLabelDenied: 'Negato',
        pushPermLabelNotRequested: 'Non richiesto',
        pushPermChecking: 'Verifica delle autorizzazioni per le notifiche su questo dispositivo.',
        pushPermUnsupported: 'Apri Happy sul tuo iPhone (aggiunto alla schermata Home) per attivare le notifiche.',
        pushPermGranted: 'Questo dispositivo può ricevere notifiche.',
        pushPermCanAsk: 'Il prompt di sistema può ancora essere mostrato di nuovo dall\'app.',
        pushPermBlocked: 'iOS ha smesso di mostrare i prompt. Apri le Impostazioni di sistema per riabilitare le notifiche.',
        pushEnableTurnOn: 'Attiva notifiche',
        pushEnableOpenSettings: 'Apri impostazioni notifiche',
        pushEnableUnavailableTitle: 'Notifiche non disponibili',
        pushEnableSubUnsupported: 'Le notifiche sono disponibili solo su iPhone e Android.',
        pushEnableSubCanAsk: 'Mostra nuovamente il prompt di sistema se iOS lo consente ancora.',
        pushEnableSubBlocked: 'Apre le Impostazioni di sistema quando iOS non mostra più il prompt.',
        pushRefreshTitle: 'Aggiorna questo dispositivo',
        pushRefreshSubDefault: 'Non ricevi notifiche? Tocca per riconnettere questo dispositivo.',
        pushRefreshSubCurrent: ({ token }: { token: string }) => `Connesso · ${token}`,
        pushEnabledSuccess: 'Le notifiche sono attivate per questo dispositivo.',
        pushNotGranted: "L'autorizzazione per le notifiche non è stata concessa.",
        pushOpenSettingsTitle: 'Apri Impostazioni',
        pushOpenSettingsBody: 'iOS non mostra più il prompt, quindi Happy ha aperto le Impostazioni.',
        pushRefreshedSuccess: 'Il dispositivo è stato riconnesso.',
        pushNotEnabledYet: 'Le notifiche non sono ancora attivate per questo dispositivo.',
        pushRequestFailed: "Impossibile richiedere l'autorizzazione per le notifiche.",
        pushRefreshFailed: 'Impossibile riconnettere questo dispositivo.',
        pushLoadFailed: 'Impossibile caricare le impostazioni delle notifiche.',
        pushDevicesTitle: ({ count }: { count: number }) => `Dispositivi registrati (${count})`,
        pushDevicesFooter: 'Dispositivi configurati per ricevere notifiche. Tocca un altro dispositivo per rimuoverlo.',
        pushDevicesEmpty: 'Nessun dispositivo registrato',
        pushDevicesEmptySub: 'Una volta registrato questo dispositivo, apparirà qui.',
        pushDeviceReceiving: 'Ricezione notifiche',
        pushDeviceOther: 'Altro dispositivo — tocca per rimuovere',
        pushDeviceRegistered: ({ date }: { date: string }) => `Registrato il ${date}`,
        pushDeviceLastSeen: ({ date }: { date: string }) => `Visto l'ultima volta il ${date}`,
        pushDeleteTitle: 'Rimuovi dispositivo',
        pushDeleteBody: ({ name }: { name: string }) => `Rimuovere ${name} dal tuo account? Smetterà di ricevere notifiche.`,
        pushDeleteFailed: 'Impossibile rimuovere il dispositivo.',
    },
    ...
    terminal: {
        ...
        autoCreateFailed: 'Impossibile raggiungere il tuo Mac per creare l\'account. Assicurati che sia acceso e sulla stessa rete Wi-Fi, poi scansiona di nuovo il codice QR.',
    },
