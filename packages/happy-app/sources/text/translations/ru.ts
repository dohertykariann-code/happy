...
export const ru: TranslationStructure = {
    ...
    settingsAccount: {
        ...
        pushFooter: 'Получайте уведомления на это устройство, когда сессии нужен ваш ввод — вопрос, запрос разрешения или завершённая задача. В списке ниже показаны устройства, настроенные на получение уведомлений.',
        pushPermission: 'Разрешение',
        pushPermLabelUnavailable: 'Недоступно',
        pushPermLabelAllowed: 'Разрешено',
        pushPermLabelDenied: 'Запрещено',
        pushPermLabelNotRequested: 'Не запрошено',
        pushPermChecking: 'Проверка разрешений на уведомления для этого устройства.',
        pushPermUnsupported: 'Откройте Happy на своём iPhone (добавьте на экран «Домой»), чтобы включить уведомления.',
        pushPermGranted: 'Это устройство может получать уведомления.',
        pushPermCanAsk: 'Системный запрос ещё можно показать снова из приложения.',
        pushPermBlocked: 'iOS перестала показывать запросы. Откройте системные Настройки, чтобы снова включить уведомления.',
        pushEnableTurnOn: 'Включить уведомления',
        pushEnableOpenSettings: 'Открыть настройки уведомлений',
        pushEnableUnavailableTitle: 'Уведомления недоступны',
        pushEnableSubUnsupported: 'Уведомления доступны только на iPhone и Android.',
        pushEnableSubCanAsk: 'Показывает системный запрос снова, если iOS ещё разрешает это.',
        pushEnableSubBlocked: 'Открывает системные Настройки, если iOS больше не показывает запрос.',
        pushRefreshTitle: 'Обновить это устройство',
        pushRefreshSubDefault: 'Не получаете уведомления? Нажмите, чтобы переподключить устройство.',
        pushRefreshSubCurrent: ({ token }: { token: string }) => `Подключено · ${token}`,
        pushEnabledSuccess: 'Уведомления включены для этого устройства.',
        pushNotGranted: 'Разрешение на уведомления не было предоставлено.',
        pushOpenSettingsTitle: 'Открыть Настройки',
        pushOpenSettingsBody: 'iOS больше не показывает запрос, поэтому Happy открыл Настройки.',
        pushRefreshedSuccess: 'Устройство было переподключено.',
        pushNotEnabledYet: 'Уведомления ещё не включены для этого устройства.',
        pushRequestFailed: 'Не удалось запросить разрешение на уведомления.',
        pushRefreshFailed: 'Не удалось переподключить устройство.',
        pushLoadFailed: 'Не удалось загрузить настройки уведомлений.',
        pushDevicesTitle: ({ count }: { count: number }) => `Зарегистрированные устройства (${count})`,
        pushDevicesFooter: 'Устройства, настроенные на получение уведомлений. Нажмите на другое устройство, чтобы удалить его.',
        pushDevicesEmpty: 'Нет зарегистрированных устройств',
        pushDevicesEmptySub: 'После регистрации устройства оно появится здесь.',
        pushDeviceReceiving: 'Получает уведомления',
        pushDeviceOther: 'Другое устройство — нажмите для удаления',
        pushDeviceRegistered: ({ date }: { date: string }) => `Зарегистрировано ${date}`,
        pushDeviceLastSeen: ({ date }: { date: string }) => `Последняя активность ${date}`,
        pushDeleteTitle: 'Удалить устройство',
        pushDeleteBody: ({ name }: { name: string }) => `Удалить ${name} из вашего аккаунта? Оно перестанет получать уведомления.`,
        pushDeleteFailed: 'Не удалось удалить устройство.',
    },
    ...
    terminal: {
        ...
        settingUpAccount: 'Настройка вашего аккаунта…',
        autoCreateFailed: 'Не удалось связаться с вашим Mac для создания аккаунта. Убедитесь, что он включён и в той же сети Wi-Fi, затем отсканируйте QR-код заново.',
    },
    ...
    imageUpload: {
        ...
        cameraPermissionMessage: 'Разрешите доступ к камере для съёмки фото в сообщениях.',
    },
