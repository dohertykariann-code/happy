...
export const ca: TranslationStructure = {
    ...
    settingsAccount: {
        ...
        pushFooter: 'Rep notificacions en aquest dispositiu quan una sessió necessita la teva intervenció — una pregunta, una sol·licitud de permís o una tasca finalitzada. La llista de sota mostra quins dispositius estan configurats per rebre-les.',
        pushPermission: 'Permís',
        pushPermLabelUnavailable: 'No disponible',
        pushPermLabelAllowed: 'Permès',
        pushPermLabelDenied: 'Denegat',
        pushPermLabelNotRequested: 'No sol·licitat',
        pushPermChecking: "S'estan comprovant els permisos de notificació per a aquest dispositiu.",
        pushPermUnsupported: "Obre Happy al teu iPhone (afegit a la teva pantalla d'inici) per activar les notificacions.",
        pushPermGranted: 'Aquest dispositiu pot rebre notificacions.',
        pushPermCanAsk: "El missatge del sistema es pot tornar a mostrar des de l'app.",
        pushPermBlocked: "iOS ha deixat de mostrar missatges. Obre la Configuració del sistema per tornar a activar les notificacions.",
        pushEnableTurnOn: 'Activa les notificacions',
        pushEnableOpenSettings: 'Obre la configuració de notificacions',
        pushEnableUnavailableTitle: 'Notificacions no disponibles',
        pushEnableSubUnsupported: 'Les notificacions només estan disponibles a iPhone i Android.',
        pushEnableSubCanAsk: 'Torna a mostrar el missatge del sistema si iOS encara ho permet.',
        pushEnableSubBlocked: "Obre la Configuració del sistema quan iOS ja no mostri el missatge.",
        pushRefreshTitle: 'Actualitza aquest dispositiu',
        pushRefreshSubDefault: 'No reps notificacions? Toca per reconnectar aquest dispositiu.',
        pushRefreshSubCurrent: ({ token }: { token: string }) => `Connectat · ${token}`,
        pushEnabledSuccess: 'Les notificacions estan activades per a aquest dispositiu.',
        pushNotGranted: 'No s\'ha concedit permís de notificació.',
        pushOpenSettingsTitle: 'Obre la Configuració',
        pushOpenSettingsBody: 'iOS ja no mostrarà el missatge, per tant Happy ha obert la Configuració.',
        pushRefreshedSuccess: 'El dispositiu ha estat reconnectat.',
        pushNotEnabledYet: 'Les notificacions encara no estan activades per a aquest dispositiu.',
        pushRequestFailed: 'No s\'ha pogut sol·licitar el permís de notificació.',
        pushRefreshFailed: 'No s\'ha pogut reconnectar aquest dispositiu.',
        pushLoadFailed: 'No s\'han pogut carregar les configuracions de notificació.',
        pushDevicesTitle: ({ count }: { count: number }) => `Dispositius registrats (${count})`,
        pushDevicesFooter: 'Dispositius configurats per rebre notificacions. Toca un altre dispositiu per eliminar-lo.',
        pushDevicesEmpty: 'Cap dispositiu registrat',
        pushDevicesEmptySub: 'Un cop registrat aquest dispositiu, apareixerà aquí.',
        pushDeviceReceiving: 'Rebent notificacions',
        pushDeviceOther: 'Un altre dispositiu — toca per eliminar',
        pushDeviceRegistered: ({ date }: { date: string }) => `Registrat el ${date}`,
        pushDeviceLastSeen: ({ date }: { date: string }) => `Vist per última vegada el ${date}`,
        pushDeleteTitle: 'Elimina el dispositiu',
        pushDeleteBody: ({ name }: { name: string }) => `Eliminar ${name} del teu compte? Deixarà de rebre notificacions.`,
        pushDeleteFailed: 'No s\'ha pogut eliminar el dispositiu.',
    },
    ...
    terminal: {
        ...
        settingUpAccount: 'Configurant el teu compte…',
        autoCreateFailed: 'No s\'ha pogut connectar amb el teu Mac per crear el compte. Assegura\'t que està encès i a la mateixa xarxa Wi-Fi, i torna a escanejar el codi QR.',
    },
